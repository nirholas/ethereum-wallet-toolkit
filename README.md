...
- **[SperaxOS](https://github.com/nirholas/ethereum-wallet-toolkit)**: the SperaxOS marketplace listing is offline while its hosting is being migrated, so use the GitHub repository in the meantime.
