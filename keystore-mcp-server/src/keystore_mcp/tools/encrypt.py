...
def register_encrypt_tools(server: Server) -> None:
    ...
    async def encrypt_keystore(
        ...
        Security Notes:
            ...
            - MAC ensures tamper detection during decryption
            - Use scrypt for maximum security (recommended)
            - Use pbkdf2 for faster operations on resource-constrained systems
        """
        ...
        try:
            ...
            address_lower = address[2:].lower()  # Without 0x, lowercase for keystore
